      ...
      <div className="relative grid grid-cols-1 md:grid-cols-2 gap-20">
        ...
        <div className="flex justify-between flex-col py-4">
          ...
          <div className="flex gap-4 pt-12 md:pt-0">
            ...
            >
              <ChevronLeft className="h-6 w-6 text-gray-900 group-hover/button:scale-110 transition-transform duration-300" />
            </button>
            <button
              onClick={handleNext}
              className="h-12 w-12 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center group/button transition-colors"
            >
              <ChevronRight className="h-6 w-6 text-gray-900 group-hover/button:scale-110 transition-transform duration-300" />
            </button>
          </div>
        </div>
      </div>
