...
const WhatsAppButton = () => {
  ...
  return (
    <Button
      ...
      className="fixed bottom-6 right-6 z-40 h-auto px-4 py-3 rounded-full bg-[#25D366] hover:bg-[#20BA5A] shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 flex items-center gap-2"
